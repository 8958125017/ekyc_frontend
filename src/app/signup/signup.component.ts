...
signup(){  
  ...
  this.isValidFormSubmitted = false;
   if(!this.businessForm.value.opsType){
          ...
          return false;    
        }else if(this.businessForm.value.bName == ''){
          this.toastr.error('Please enter Business Name');
          return false;    
         ...
         //  return false;  
         // }
         else if(this.businessForm.value.bType== ''){
       ...
       let postData={
                ...
                "business_type":this.businessForm.value.bType,
                "businessName":this.businessForm.value.bName,
                ...
                "businessCountry":this.businessForm.value.country,
                "businessState":this.businessForm.value.state,
